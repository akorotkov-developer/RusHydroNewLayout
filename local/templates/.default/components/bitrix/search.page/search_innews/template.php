...
<div class="content-text">
    <div class="search-page">
        ...
        <form action="" class="search-page_form" method="get">
            ...
            <input type="hidden" name="how" value="<?echo $arResult["REQUEST"]["HOW"]=="d"? "d": "r"?>" />
                ...
                <?else:?>
                    <input name="q" placeholder="Пример строки поиска"  value="<?=$arResult["REQUEST"]["QUERY"]?>" class="search-page_input" type="search">
                <?endif;?>
